...
import BuySellLogo from '../../assets/buy-sell-crop-logo.jpg'
        ...
        <footer>
            <div className="footer-top">
              ...
              <div className="footer-col">
                ...
                <div className="footer-col-item"><a href='/about'>About our Team</a> </div>
                <div className="footer-col-item">BuySell Blog</div>
                <div className="footer-col-item"><a href='/contact'>Contact Us</a> </div>
                <div className="footer-col-item">BuySell for Businesses</div>
              </div>
              <div className="footer-col">
                <div className="footer-col-head">BuySell</div>
                <div className="footer-col-item"><a href="/contact">Help</a> </div>
            ...
            <div className="footer-bottom">
              Made with <span className="heart">❤️</span> at Buy And Sell
            </div>
        </footer>
    </div>
  )
